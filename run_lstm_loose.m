...
%% 主循环
fprintf('Running LSTM loose coupling...\n');
for k = 1:nn:len
...
%% 计算误差
error_pos_east_loose_LSTM = East_est - East;
error_pos_north_loose_LSTM = North_est - North;

%% 保存
save('results/lstm_loose_results.mat', ...
    'error_pos_north_loose_LSTM', 'error_pos_east_loose_LSTM');
fprintf('Done!\n');